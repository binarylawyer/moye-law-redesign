...
const SushiServiceHero: React.FC<SushiServiceHeroProps> = ({ title, description }) => {
    return (
        <section className="relative pt-32 pb-20 overflow-hidden bg-white">
            {/* Geometric design elements - Same as V1 but potentially tighter */}
            ...
            <div className="absolute top-32 right-0 w-24 h-64 bg-[#003B98]/80 -z-0"></div>

            <div className="container mx-auto px-8 max-w-7xl relative z-10">
                <div className="max-w-4xl ml-12 md:ml-40">
                    {/* Content */}
                    <motion.h1
                        className="font-display text-5xl md:text-6xl text-navy mb-6 leading-tight"
                    ...
                    <motion.p
                        className="text-lg md:text-xl text-navy/70 mb-8 max-w-xl"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
