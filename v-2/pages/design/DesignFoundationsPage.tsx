...
/* 
 * DESIGN SYSTEM NODE 00: FOUNDATIONS
 * Purpose: The immutable constants of the V2 Design System (Colors, Type).
 */
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-9">
                        ...
                        {/* SECTION 3: LEGACY FONTS */}
                        <section id="legacy" className="mb-32 opacity-60">
                            <div className="flex items-center mb-12">
                                <div className="w-12 h-1 bg-gray-300 mr-4"></div>
                                <div>
                                    <h2 className="font-display text-3xl text-gray-500">Legacy Typography (Audit)</h2>
                                    <p className="font-mono text-xs text-gray-300 mt-2">DETECTED IN LEGACY STYLESHEETS</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="bg-gray-50 p-6 border border-gray-200">
                                    ...
                                    <p className="text-sm text-gray-500 mb-4">Found in `src/fonts.css` and Markdown styles. Used as a sans-serif alternate.</p>
                                    <p style={{ fontFamily: 'Montserrat, sans-serif' }} className="text-xl">The quick brown fox jumps over the lazy dog.</p>
                                </div>
                                <div className="bg-gray-50 p-6 border border-gray-200">
                                    <h4 className="font-bold text-navy mb-2">Poppins</h4>
                                    <p className="text-sm text-gray-500 mb-4">Found in `index.html` inline styles. Used for pre-loader.</p>
                                    <p style={{ fontFamily: 'Poppins, sans-serif' }} className="text-xl">The quick brown fox jumps over the lazy dog.</p>
                                </div>
                            </div>
                        </section>
