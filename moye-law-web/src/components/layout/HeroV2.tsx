...
const HeroV2 = () => {
    return (
        <div className="relative w-full min-h-[90vh] bg-white pt-20 md:pt-24 flex flex-col">
            ...
            <div className="flex-grow grid grid-cols-1 md:grid-cols-12 h-full border-b-4 border-navy">

                {/* === BLOCK A: THE PROMISE (60% approx - Cols 1-7) === */}
                <div className="col-span-1 md:col-span-7 bg-white p-8 md:p-16 flex flex-col justify-center relative border-r-4 border-navy">
                ...
                <div className="col-span-1 md:col-span-5 bg-grey relative overflow-hidden group h-full min-h-[50vh]">
                    {/* Portrait Placeholder */}
                    <div className="absolute inset-0 bg-gray-300 flex items-center justify-center">
                        <span className="font-display text-gray-500 italic text-2xl">Portrait: Christopher Moye</span>
                    </div>

                    {/* THE GLITCH OVERLAY (Hover Effect) */}
                    <div className="absolute inset-0 bg-navy/90 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col justify-center items-center p-8 backdrop-blur-sm">
                        {/* Schematic Grid */}
