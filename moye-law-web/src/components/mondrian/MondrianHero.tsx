            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[85vh]">
                ...
                <div className="col-span-1 lg:col-span-7 p-8 md:p-16 lg:p-24 flex flex-col justify-center border-b-4 lg:border-b-0 lg:border-r-4 border-navy relative">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-0">
                            <Link href="/contact" className="px-8 py-4 bg-navy text-white font-serif italic text-xl border-2 border-navy hover:bg-white hover:text-navy transition-colors flex items-center justify-center">
                                Schedule Consultation <ArrowRight className="ml-2 w-5 h-5" />
                            </Link>
                            <Link href="/about" className="px-8 py-4 bg-white text-navy font-mono text-sm border-2 border-navy border-t-0 sm:border-t-2 sm:border-l-0 hover:bg-gray-50 flex items-center justify-center">
                                View_Methodology()
                            </Link>
                        </div>
                    </motion.div>
                ...
                <div className="col-span-1 lg:col-span-5 bg-gray-50 grid grid-rows-6 relative overflow-hidden">
                    ...
                    <div className="row-span-4 bg-navy p-8 border-b-4 border-navy relative overflow-hidden group">
                        ...
                        <div className="absolute inset-0 bg-navy/90 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                    ...
                    <div className="row-span-2 grid grid-cols-3">
                        <div className="col-span-2 bg-gold border-r-4 border-navy flex items-center justify-center p-6 hover:brightness-110 transition-all cursor-pointer">
                            <span className="font-display text-navy text-3xl font-bold italic">30 Years</span>
                        </div>
                        <div className="col-span-1 bg-red-800 flex items-center justify-center hover:bg-red-700 transition-colors cursor-pointer">
