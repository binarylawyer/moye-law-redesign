...
// Helper for scroll animations (since we removed the complex observer logic for now to keep it simple, or we can keep it)
// For now, I'll keep the refs but simplify the effect to just show content to avoid hydration issues if possible, 
// or keep the effect if it works well. The legacy code used vanilla JS class manipulation.
        ...
        const observer = new IntersectionObserver((entries) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
                    // We'll use Tailwind classes directly on the elements for simple transitions
            ...
            >
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        <div className="border-2 border-[#D6001C] rounded-md overflow-hidden bg-white">
                        ...
                        <div className="border-2 border-[#4D80D4] rounded-md overflow-hidden bg-white">
