    ...
    return (
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <Link href="/admin/design/motion" className="group block bg-white border-2 border-navy p-8 hover:shadow-[8px_8px_0px_0px_#C99D56] transition-shadow">
                    <div className="h-2 w-12 bg-navy mb-6 group-hover:w-24 transition-all duration-300"></div>
                    <h3 className="font-display text-2xl text-navy mb-2">Motion Physics</h3>
                    <p className="font-mono text-xs text-gray-500 mb-6">KINETIC // STRUCTURAL // TIMING</p>
                    <span className="flex items-center text-sm font-bold text-navy group-hover:text-gold transition-colors">
                        View Motion Laws <ArrowRight className="w-4 h-4 ml-2" />
                    </span>
                </Link>

                <Link href="/practice/directory" className="group block bg-white border-2 border-navy p-8 hover:shadow-[8px_8px_0px_0px_#C99D56] transition-shadow">
                    <div className="h-2 w-12 bg-navy mb-6 group-hover:w-24 transition-all duration-300"></div>
                    <h3 className="font-display text-2xl text-navy mb-2">Practice Directory</h3>
                    <p className="font-mono text-xs text-gray-500 mb-6">INVENTORY // STATUS // LINKS</p>
                    <span className="flex items-center text-sm font-bold text-navy group-hover:text-gold transition-colors">
                        View All Pages <ArrowRight className="w-4 h-4 ml-2" />
                    </span>
                </Link>

                <Link href="/admin/design/bento-grids" className="group block bg-white border-2 border-navy p-8 hover:shadow-[8px_8px_0px_0px_#C99D56] transition-shadow">
                    <div className="h-2 w-12 bg-navy mb-6 group-hover:w-24 transition-all duration-300"></div>
                    <h3 className="font-display text-2xl text-navy mb-2">Bento Grids</h3>
                    <p className="font-mono text-xs text-gray-500 mb-6">MONDRIAN // STRIPE // FLOATING</p>
                    <span className="flex items-center text-sm font-bold text-navy group-hover:text-gold transition-colors">
                        View Layouts <ArrowRight className="w-4 h-4 ml-2" />
                    </span>
                </Link>
