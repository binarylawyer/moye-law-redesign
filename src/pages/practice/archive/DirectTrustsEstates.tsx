          ...
          <div className="container mx-auto px-8">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="bg-white border-4 border-black p-8 md:p-12 w-full md:w-2/3">
                <h1 className="font-display text-black text-4xl md:text-5xl lg:text-6xl mb-8">Trusts & Estates</h1>
            ...
            <div className="container mx-auto px-4">
              <div className="flex flex-col md:flex-row">
                ...
                <div className="bg-white w-full md:flex-1 p-8 border-4 border-black">
                  <h2 className="font-display text-3xl mb-4">Protect Your Legacy — Contact Us Today</h2>
