        ...
        <section className="relative pt-48 pb-32 overflow-hidden bg-white">
          ...
          <div className="container mx-auto px-8 max-w-7xl relative z-10">
            <div className="max-w-4xl ml-40">
              <h1 className="reveal font-display text-5xl md:text-7xl text-navy mb-10 leading-tight">
          ...
          <div className="container mx-auto px-8 max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div className="reveal" style={{ transitionDelay: '0.2s' }}>
                <h2 className="font-display text-4xl text-navy mb-6">Our Story</h2>
          ...
          <div className="container mx-auto px-8 max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
              ...
              <div className="reveal md:col-span-7" style={{ transitionDelay: '0.1s' }}>
                <h2 className="font-display text-4xl text-navy mb-6">Technical Innovation, Family Values</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="border-l-4 border-[#003B98] pl-6">
                    <h3 className="font-display text-2xl text-navy mb-3">Tech-Forward</h3>
                  ...
                  <div className="border-l-4 border-[#D6001C] pl-6">
                    <h3 className="font-display text-2xl text-navy mb-3">Family-Centered</h3>
                    <p className="text-navy/70">
              ...
              <div className="reveal md:col-span-5 relative" style={{ transitionDelay: '0.2s' }}>
                <div className="grid grid-cols-2 grid-rows-2 gap-4 h-full">
                  <div className="bg-white p-8 border-4 border-black flex flex-col items-center justify-center text-center">
                    ...
                    <p className="font-display text-navy">IP Protection</p>
                  </div>
                  <div className="bg-[#FFD500] p-8 border-4 border-black flex flex-col items-center justify-center text-center">
                    ...
                    <p className="font-display text-navy">Estate Planning</p>
                  </div>
                  <div className="bg-[#D6001C] p-8 border-4 border-black flex flex-col items-center justify-center text-center">
                    ...
                    <p className="font-display text-white">Family Law</p>
                  </div>
                  <div className="bg-white p-8 border-4 border-black flex flex-col items-center justify-center text-center">
                    <div className="text-3xl mb-2 font-display text-navy">+</div>
                    <p className="font-display text-navy">Integrated Approach</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-24 bg-light-gray border-t-4 border-black">
          <div className="container mx-auto px-8 max-w-7xl">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-display text-4xl text-navy mb-12 text-center">Client Stories</h2>
          ...
          <div className="container mx-auto px-8 max-w-7xl relative z-10">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="reveal font-display text-4xl text-navy mb-6">Experience It For Yourself</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
                ...
                <div className="md:col-span-7 reveal" style={{ transitionDelay: '0.2s' }}>
                  <form className="bg-white p-8 border-4 border-black">
                    <h3 className="font-display text-2xl text-navy mb-6">Request a Consultation</h3>
