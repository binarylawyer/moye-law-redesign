    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-16">
        ...
        <section className="py-24 px-6">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="font-sans text-4xl md:text-5xl mb-6 text-primary">About Moye Law</h1>
        ...
        <section className="py-16 px-6 bg-light-gray">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto">
              <h2 className="font-sans text-3xl md:text-4xl mb-8 text-primary text-center">Our Mission</h2>
              ...
              <div className="mt-16 grid md:grid-cols-2 gap-8">
                <div className="bg-white p-8 rounded-lg border border-primary-light/20">
                  <h3 className="font-sans text-xl mb-4 text-primary">Family Values</h3>
                ...
                <div className="bg-white p-8 rounded-lg border border-primary-light/20">
                  <h3 className="font-sans text-xl mb-4 text-primary">Future-Forward</h3>
                  <p className="text-charcoal/80">
        ...
        <section className="py-16 px-6">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto">
              <h2 className="font-sans text-3xl md:text-4xl mb-8 text-primary text-center">Our Story</h2>
        ...
        <section className="py-16 px-6 bg-light-gray">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-sans text-3xl md:text-4xl mb-8 text-primary">Our Team</h2>
