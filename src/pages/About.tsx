    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-16">
        ...
        <section className="py-96 px-24">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="font-sans text-4xl md:text-5xl mb-24 text-primary">About Moye Law</h1>
        ...
        <section className="py-64 px-24 bg-light-gray">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto">
              <h2 className="font-sans text-3xl md:text-4xl mb-32 text-primary text-center">Our Mission</h2>
              <p className="text-charcoal/80 text-lg mb-24 text-center">
              ...
              <div className="mt-64 grid md:grid-cols-2 gap-32">
                <div className="bg-white p-32 rounded-lg border border-primary-light/20">
                  <h3 className="font-sans text-xl mb-16 text-primary">Family Values</h3>
                ...
                <div className="bg-white p-32 rounded-lg border border-primary-light/20">
                  <h3 className="font-sans text-xl mb-16 text-primary">Future-Forward</h3>
                  <p className="text-charcoal/80">
        ...
        <section className="py-64 px-24">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto">
              <h2 className="font-sans text-3xl md:text-4xl mb-32 text-primary text-center">Our Story</h2>
        ...
        <section className="py-64 px-24 bg-light-gray">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-sans text-3xl md:text-4xl mb-32 text-primary">Our Team</h2>
              <p className="text-charcoal/80 mb-32">
              ...
              >
                Meet our team <ChevronRight className="ml-8 h-4 w-4" />
              </Link>
            </div>
          </div>
        </section>
