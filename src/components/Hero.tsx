      ...
      <div className="absolute inset-0 flex items-center">
        <div className="container mx-auto px-8">
          <div className="max-w-3xl">
            <h1 className="font-display text-4xl md:text-6xl text-white mb-6 reveal">
              Family Values, <br /><span className="text-[#FFD500]">Future-Forward</span> Legal Solutions
            </h1>
            <p className="text-xl text-white/80 mb-8 reveal" style={{ transitionDelay: '0.1s' }}>
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-12 reveal" style={{ transitionDelay: '0.2s' }}>
              <Link 
                to="/contact" 
                className="inline-flex items-center justify-center px-8 py-3 font-sans text-lg bg-[#FFD500] text-black border-2 border-[#FFD500] hover:bg-[#FFD500]/90 rounded-none transition-colors"
              >
                Schedule a Consultation <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
              <Link 
                to="/experience-the-difference" 
                className="inline-flex items-center justify-center px-8 py-3 font-sans text-lg text-white border-2 border-white hover:bg-white/10 rounded-none transition-colors"
              >
                Our Approach
              </Link>
            </div>
