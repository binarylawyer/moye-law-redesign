    ...
    <section className="py-6 md:py-10 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <article className="bg-white rounded-lg shadow-md p-8 prose prose-base max-w-none prose-headings:font-serif prose-headings:text-navy prose-p:text-charcoal/80 prose-a:text-gold prose-a:no-underline hover:prose-a:underline">
            <ReactMarkdown
              ...
              components={{
                ...
                code: ({node, inline, ...props}) => 
                  inline ? 
                    ...
                    <code className="block bg-slate-100 p-4 rounded text-navy/90 text-sm overflow-x-auto" {...props} />,
                
                pre: ({node, ...props}) => <pre className="bg-slate-100 p-4 rounded overflow-x-auto my-4" {...props} />
              }}
            >
              {content}
            </ReactMarkdown>
