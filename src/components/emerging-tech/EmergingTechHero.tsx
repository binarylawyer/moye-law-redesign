...
const EmergingTechHero: React.FC = () => {
  return (
    <section className="py-72 md:py-96 bg-pastel-blue/20">
      <div className="container mx-auto px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-display text-navy text-5xl md:text-6xl lg:text-7xl mb-16">Emerging Technology Law</h1>
...
export default EmergingTechHero;
